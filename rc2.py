...
def genEven():
    x = 2*random.randrange(0,11,1)
    return x

#Generates a random odd number
def genOdd():
    x = 2*random.randrange(0,11,1)+1
    return x

#Generates a random integer within range
def genInt():
    x = random.randrange(0,23,1)
    return x
...
def genCoords():
    ...
    for i in range(3000):
        ...
        h = random.randrange(0, 22, 3)
        k = random.randrange(0, 22, 3)
        l = random.randrange(0, 22, 3)
